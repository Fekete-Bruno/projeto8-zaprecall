    ...
    return(
        <div className="content">
            ...
            (<TitleScreen 
                ...
                cardsAmount={cardsAmount} setCardsAmount={setCardsAmount} />) 
            : (<DeckScreen questions={decks[deckNumber].questions} setScreen={setScreen} deckGoal={deckGoal} cardsAmount={cardsAmount} deckName={decks[deckNumber].deckName}/>)}
        </div>     
    );
}